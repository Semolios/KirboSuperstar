...
void cAnimator::LoadAnimations()
{
	...
	mapStates["jump"].push_back(new olc::Sprite("assets/gfx/kirboJump00.png"));
	mapStates["jump"].push_back(new olc::Sprite("assets/gfx/kirboJump01.png"));
	mapStates["jump"].push_back(new olc::Sprite("assets/gfx/kirboJump02.png"));
	mapStates["jump"].push_back(new olc::Sprite("assets/gfx/kirboJump03.png"));
	mapStates["jump"].push_back(new olc::Sprite("assets/gfx/kirboJump04.png"));
	mapStates["jump"].push_back(new olc::Sprite("assets/gfx/kirboJump05.png"));
	...
	mapStates["flying"].push_back(new olc::Sprite("assets/gfx/kirboFlying03.png"));
	mapStates["flying"].push_back(new olc::Sprite("assets/gfx/kirboFlying02.png"));
	mapStates["flying"].push_back(new olc::Sprite("assets/gfx/kirboFlying01.png"));
