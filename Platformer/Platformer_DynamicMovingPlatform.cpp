...
#pragma region Sceneries
	...
	mapPlatforms["doorHide3"].push_back(new olc::Sprite("assets/gfx/doorHide3.png"));
	mapPlatforms["doorHide4"].push_back(new olc::Sprite("assets/gfx/doorHide4.png"));
	mapPlatforms["crystal"].push_back(new olc::Sprite("assets/gfx/crystal.png"));
	mapPlatforms["snowHideout"].push_back(new olc::Sprite("assets/gfx/snowHideout.png"));
	...
	mapPlatforms["branches2"].push_back(new olc::Sprite("assets/gfx/branches2.png"));
	...
	mapPlatforms["grassAngle"].push_back(new olc::Sprite("assets/gfx/grassAngle.png"));
	mapPlatforms["grassSide1"].push_back(new olc::Sprite("assets/gfx/grassSide1.png"));
	mapPlatforms["grassSide2"].push_back(new olc::Sprite("assets/gfx/grassSide2.png"));
	mapPlatforms["grassSide3"].push_back(new olc::Sprite("assets/gfx/grassSide3.png"));
	mapPlatforms["grassSide4"].push_back(new olc::Sprite("assets/gfx/grassSide4.png"));
	mapPlatforms["grassBot1"].push_back(new olc::Sprite("assets/gfx/grassBot1.png"));
	mapPlatforms["grassBot2"].push_back(new olc::Sprite("assets/gfx/grassBot2.png"));
	mapPlatforms["grassTop1"].push_back(new olc::Sprite("assets/gfx/grassTop1.png"));
	mapPlatforms["grassTop2"].push_back(new olc::Sprite("assets/gfx/grassTop2.png"));
	mapPlatforms["doorHide7"].push_back(new olc::Sprite("assets/gfx/doorHide7.png"));
	mapPlatforms["metalPlateAngle"].push_back(new olc::Sprite("assets/gfx/metalPlateAngle.png"));
	mapPlatforms["metalPlateAngle2"].push_back(new olc::Sprite("assets/gfx/metalPlateAngle2.png"));
	mapPlatforms["dangerZone"].push_back(new olc::Sprite("assets/gfx/dangerZone.png"));
	mapPlatforms["groundBlock"].push_back(new olc::Sprite("assets/gfx/groundBlock.png"));
	mapPlatforms["groundPlatform"].push_back(new olc::Sprite("assets/gfx/groundPlatform.png"));
	mapPlatforms["sewer"].push_back(new olc::Sprite("assets/gfx/sewer.png"));
	mapPlatforms["waterBowl"].push_back(new olc::Sprite("assets/gfx/waterBowl00.png"));
	mapPlatforms["waterBowl"].push_back(new olc::Sprite("assets/gfx/waterBowl01.png"));
	mapPlatforms["waterBowl"].push_back(new olc::Sprite("assets/gfx/waterBowl02.png"));
	mapPlatforms["lavaFlow"].push_back(new olc::Sprite("assets/gfx/lavaFlow00.png"));
...
#pragma region Sceneries
	...
	mapDecPlatforms["doorHide3"].push_back(new olc::Decal(mapPlatforms["doorHide3"][0]));
	mapDecPlatforms["doorHide4"].push_back(new olc::Decal(mapPlatforms["doorHide4"][0]));
	mapDecPlatforms["crystal"].push_back(new olc::Decal(mapPlatforms["crystal"][0]));
	mapDecPlatforms["snowHideout"].push_back(new olc::Decal(mapPlatforms["snowHideout"][0]));
	...
	mapDecPlatforms["branches2"].push_back(new olc::Decal(mapPlatforms["branches2"][0]));
	...
	mapDecPlatforms["grassAngle"].push_back(new olc::Decal(mapPlatforms["grassAngle"][0]));
	mapDecPlatforms["grassSide1"].push_back(new olc::Decal(mapPlatforms["grassSide1"][0]));
	mapDecPlatforms["grassSide2"].push_back(new olc::Decal(mapPlatforms["grassSide2"][0]));
	mapDecPlatforms["grassSide3"].push_back(new olc::Decal(mapPlatforms["grassSide3"][0]));
	mapDecPlatforms["grassSide4"].push_back(new olc::Decal(mapPlatforms["grassSide4"][0]));
	mapDecPlatforms["grassBot1"].push_back(new olc::Decal(mapPlatforms["grassBot1"][0]));
	mapDecPlatforms["grassBot2"].push_back(new olc::Decal(mapPlatforms["grassBot2"][0]));
	mapDecPlatforms["grassTop1"].push_back(new olc::Decal(mapPlatforms["grassTop1"][0]));
	mapDecPlatforms["grassTop2"].push_back(new olc::Decal(mapPlatforms["grassTop2"][0]));
	mapDecPlatforms["doorHide7"].push_back(new olc::Decal(mapPlatforms["doorHide7"][0]));
	mapDecPlatforms["metalPlateAngle"].push_back(new olc::Decal(mapPlatforms["metalPlateAngle"][0]));
	mapDecPlatforms["metalPlateAngle2"].push_back(new olc::Decal(mapPlatforms["metalPlateAngle2"][0]));
	mapDecPlatforms["dangerZone"].push_back(new olc::Decal(mapPlatforms["dangerZone"][0]));
	mapDecPlatforms["groundBlock"].push_back(new olc::Decal(mapPlatforms["groundBlock"][0]));
	mapDecPlatforms["groundPlatform"].push_back(new olc::Decal(mapPlatforms["groundPlatform"][0]));
	mapDecPlatforms["sewer"].push_back(new olc::Decal(mapPlatforms["sewer"][0]));
	mapDecPlatforms["waterBowl"].push_back(new olc::Decal(mapPlatforms["waterBowl"][0]));
	mapDecPlatforms["waterBowl"].push_back(new olc::Decal(mapPlatforms["waterBowl"][0]));
	mapDecPlatforms["waterBowl"].push_back(new olc::Decal(mapPlatforms["waterBowl"][1]));
	mapDecPlatforms["waterBowl"].push_back(new olc::Decal(mapPlatforms["waterBowl"][1]));
	mapDecPlatforms["waterBowl"].push_back(new olc::Decal(mapPlatforms["waterBowl"][2]));
	mapDecPlatforms["waterBowl"].push_back(new olc::Decal(mapPlatforms["waterBowl"][2]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][0]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][0]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][0]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][0]));
	...
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][1]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][1]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][2]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][2]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][2]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][2]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][3]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][3]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][3]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][3]));
	mapDecPlatforms["lavaFlow"].push_back(new olc::Decal(mapPlatforms["lavaFlow"][2]));
