...
cDynamicMovingPlatformVerSingle::cDynamicMovingPlatformVerSingle(float ox, float oy, std::vector<olc::Decal*> map, std::wstring iced, float ty, float vy, std::wstring trigger)
